...
export default function Header() {
  ...
  return (
    <div className= {`bg-white bg-opacity-70 flex justify-center z-50 w-screen ${ isHome ? "fixed top-0 left-0 w-full" : "relative"}`}>
      <div className="w-[1152px] h-auto flex justify-between items-center py-2 border-b border-gray-500">
